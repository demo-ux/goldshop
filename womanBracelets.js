...
let outerDivWmBrc = document.querySelector('.productsOuterDiv');

let womanBracelets = products.filter(product => product.gender === 'woman' & product.category === 'bracelet')
...
outerDivWmBrc.innerHTML = mapWmBracelets.join('');
...
outerDivWmBrc.innerHTML = searchedResult.join('');
}
...
function onPriceClick(){
 ...
 console.log(womanBracelets);
 outerDivWmBrc.innerHTML = result1.join('');
 ...
 outerDivWmBrc.innerHTML = result2.join('');
 ...
 outerDivWmBrc.innerHTML = result3.join('');
...
outerDivWmBrc.innerHTML = result4.join('');
...
outerDivWmBrc.innerHTML = result5.join('');
...
outerDivWmBrc.innerHTML = result6.join('');
...
outerDivWmBrc.innerHTML = result7.join('');
...
outerDivWmBrc.innerHTML = result8.join('');
}
}
